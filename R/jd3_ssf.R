...
jd3_ssf_ar<-function(name, ar, fixedar=FALSE, variance=.01, fixedvariance=FALSE, nlags=0, zeroinit=FALSE){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "ar", name, .jarray(ar), fixedar, variance, fixedvariance, as.integer(nlags), zeroinit)
...
jd3_ssf_cycle<-function(name, factor=.9, period=60, fixed=F, variance=.01, fixedvariance=FALSE){
  ...
  jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "cycle", name, factor, period, fixed, variance, fixedvariance)
...
jd3_ssf_ar2<-function(name, ar, fixedar=FALSE, variance=.01, fixedvariance=FALSE, nlags=0, nfcasts=0){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "ar", name, .jarray(ar), fixedar, variance, fixedvariance, as.integer(nlags), as.integer(nfcasts))
...
jd3_ssf_sae<-function(name, ar, fixedar=FALSE, lag=1, zeroinit=FALSE){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "sae", name, .jarray(ar), fixedar, as.integer(lag), zeroinit)
...
jd3_ssf_msae<-function(name, nwaves, ar, fixedar=TRUE, lag=1){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "waveSpecificSurveyError", name, as.integer(nwaves), matrix_r2jd(ar), fixedar, as.integer(lag))
...
jd3_ssf_msae2<-function(name, vars, fixedvars=F, ar, fixedar=T, lag=1){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "waveSpecificSurveyError", name, vars, fixedvars, matrix_r2jd(ar), fixedar, as.integer(lag))
...
jd3_ssf_msae3<-function(name, vars, fixedvars=F, ar, fixedar=T, k, lag=1){
  ...
  jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "waveSpecificSurveyError", name, vars, fixedvars, .jarray(ar), fixedar, matrix_r2jd(k), as.integer(lag))
...
jd3_ssf_locallevel<-function(name, variance=.01, fixed=FALSE, initial=NaN){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "localLevel", name, variance, fixed, initial)
...
jd3_ssf_locallineartrend<-function(name, levelVariance=.01, slopevariance=.01, fixedLevelVariance=FALSE, fixedSlopeVariance=FALSE ){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "localLinearTrend", name, levelVariance, slopevariance, fixedLevelVariance, fixedSlopeVariance)
...
jd3_ssf_seasonal<-function(name, period, type="Crude", variance=.01, fixed=FALSE){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "seasonalComponent", name, type, as.integer(period), variance, fixed)
...
jd3_ssf_noise<-function(name, variance=.01, fixed=FALSE){
			...
			jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "noise", name, variance, fixed)
...
jd3_ssf_arima<-function(ar, diff, ma, var=1, fixed =FALSE){
  jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/ssf/univariate/ISsf;", "arima", as.double(ar), as.double(diff), as.double(ma), var, fixed)
  new (Class = "JD3_Ssf", internal = jrslt)
}


jd3_ssf_arma<-function(ar, ma, var=1, fixed =FALSE){
  jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/ssf/univariate/ISsf;", "arma", as.double(ar), as.double(ma), var, fixed)
  new (Class = "JD3_Ssf", internal = jrslt)
}
...
jd3_ssf_sarima<-function(name, period, orders, seasonal, parameters=NULL, fixedparameters=FALSE, var=1, fixedvariance =FALSE){
  ...
  jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "sarima", name, as.integer(period), as.integer(orders), as.integer(seasonal), jp, fixedparameters, var, fixedvariance)
  new (Class = "JD3_SsfItem", internal = jrslt)
}
...
jd3_ssf_reg<-function(ssf, x, var=0, mvar=NULL){
  ...
  if (is.null(mvar)){
    if (var == 0)
      jssf<-.jcall("rssf/RegressionModels", "Ljdplus/ssf/univariate/ISsf;", "fixed", ssf@internal, matrix_r2jd(x))
    else
      jssf<-.jcall("rssf/RegressionModels", "Ljdplus/ssf/univariate/ISsf;", "timeVarying", ssf@internal, matrix_r2jd(x), var)
  }else{
    jssf<-.jcall("rssf/RegressionModels", "Ljdplus/ssf/univariate/ISsf;", "timeVarying", ssf@internal, matrix_r2jd(x), matrix_r2jd(mvar))
  }
...
jd3_ssf_td<-function(name, period, start, length, groups=c(1,2,3,4,5,6,0), contrast=TRUE, variance=1, fixed=FALSE){
  ...
  jrslt<-.jcall("jdplus/msts/AtomicModels", "Ljdplus/msts/ModelItem;", "tdRegression", name, jdomain, as.integer(groups), contrast, variance, fixed)
  new (Class = "JD3_SsfItem", internal = jrslt)
}
